...
final class MongoConfig {
    ...
    public static <T1, T2, T3, R> void registerMethodSubstitution(Function3<T1, T2, T3, R> from,
    ...
    public static <T, U, R> void registerMethodSubstitution(Function2<T, U, R> from,
    ...
    public static <T, R> void registerMethodSubstitution(Function1<T, R> from,
    ...
    public static <R> void registerMethodSubstitution(Function0<R> from,
    ...
    public static <T1, T2, T3, R> boolean unregisterMethodSubstitution(Function3<T1, T2, T3, R> from) {
        return unregisterMethodSubstitution0(from);
    }

    public static <T, U, R> boolean unregisterMethodSubstitution(Function2<T, U, R> from) {
        return unregisterMethodSubstitution0(from);
    }

    public static <T, R> boolean unregisterMethodSubstitution(Function1<T, R> from) {
        return unregisterMethodSubstitution0(from);
    }

    public static <R> boolean unregisterMethodSubstitution(Function0<R> from) {
        return unregisterMethodSubstitution0(from);
    }
